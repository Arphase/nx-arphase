...
export class RemoveTemporalEnums1666116042519 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."revisions_status_enum" AS ENUM('elegible', 'needsRepairs', 'notElegible')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."vehicles_status_enum" AS ENUM('elegible', 'needsRevision', 'hasActiveGuarantee', 'notElegible', 'soldWidhoutGuarantee')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."revisionRequests_status_enum" AS ENUM('new', 'inProgress', 'completed')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."users_role_enum" AS ENUM('superAdmin', 'admin', 'agencyUser', 'repairman')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."guarantees_status_enum" AS ENUM('outstanding', 'paid', 'cancelled', 'expired')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."guarantees_status_enum_old" AS ENUM('outstanding', 'paid', 'cancelled', 'expired', '1', '2', '3', '4')`);
        await queryRunner.query(`ALTER TABLE "guarantees" ALTER COLUMN "status" DROP DEFAULT`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."users_role_enum_old" AS ENUM('superAdmin', 'admin', 'agencyUser', 'repairman', '1', '2', '3', '4')`);
        await queryRunner.query(`ALTER TABLE "users" ALTER COLUMN "role" DROP DEFAULT`);
        await queryRunner.query(`ALTER TABLE "users" ALTER COLUMN "role" TYPE "public"."users_role_enum_old" USING "role"::"text"::"public"."users_role_enum_old"`);
        await queryRunner.query(`ALTER TABLE "users" ALTER COLUMN "role" SET DEFAULT 'agencyUser'`);
        await queryRunner.query(`DROP TYPE "public"."users_role_enum"`);
        await queryRunner.query(`ALTER TYPE "public"."users_role_enum_old" RENAME TO "users_role_enum"`);
        await queryRunner.query(`CREATE TYPE "public"."revisionRequests_status_enum_old" AS ENUM('new', 'inProgress', 'completed', '1', '2', '3')`);
        await queryRunner.query(`ALTER TABLE "revisionRequests" ALTER COLUMN "status" DROP DEFAULT`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."vehicles_status_enum_old" AS ENUM('elegible', 'needsRevision', 'hasActiveGuarantee', 'notElegible', 'soldWidhoutGuarantee', '1', '2', '3', '4', '5')`);
        await queryRunner.query(`ALTER TABLE "vehicles" ALTER COLUMN "status" DROP DEFAULT`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."revisions_status_enum_old" AS ENUM('elegible', 'needsRepairs', 'notElegible', '1', '2', '3')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."clients_persontype_enum_old" AS ENUM('physical', 'moral', '1', '2')`);
