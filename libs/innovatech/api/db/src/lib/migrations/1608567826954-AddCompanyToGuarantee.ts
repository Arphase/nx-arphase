...
export class AddCompanyToGuarantee1608567826954 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "guarantees" ADD CONSTRAINT "FK_60d713c61ad833f7e56a7be40e8" FOREIGN KEY ("companyId") REFERENCES "companies"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }
