...
// Dto Validators
export function validatePersonTypeRfc(type: PersonTypes | string, rfc: string): boolean {
  return type === 'any' ? isRfc(rfc) : validations[PersonTypes[type]](rfc);
}
    ...
    registerDecorator({
      ...
      validator: {
        validate(value: any, args: ValidationArguments) {
          ...
          const relatedValue = relatedPropertyName !== 'any' ? (args.object as any)[relatedPropertyName] : 'any';
