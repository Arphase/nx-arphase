...
export class AddTemporalEnums1666115727992 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."revisions_status_enum" AS ENUM('elegible', 'needsRepairs', 'notElegible', '1', '2', '3')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."vehicles_status_enum" AS ENUM('elegible', 'needsRevision', 'hasActiveGuarantee', 'notElegible', 'soldWidhoutGuarantee', '1', '2', '3', '4', '5')`,
    );
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."revisionRequests_status_enum" AS ENUM('new', 'inProgress', 'completed', '1', '2', '3')`,
    );
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."users_role_enum" AS ENUM('superAdmin', 'admin', 'agencyUser', 'repairman', '1', '2', '3', '4')`,
    );
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."guarantees_status_enum" AS ENUM('outstanding', 'paid', 'cancelled', 'expired', '1', '2', '3', '4')`,
    );
