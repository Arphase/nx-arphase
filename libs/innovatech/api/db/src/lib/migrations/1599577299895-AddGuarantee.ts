...
export class AddGuarantee1599577299895 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "moralPersons" ("id" SERIAL NOT NULL, "businessName" character varying NOT NULL, "constitutionDate" TIMESTAMP NOT NULL, "distributor" character varying, "adviser" character varying NOT NULL, CONSTRAINT "PK_29820f8583a7c89163c2bf90b68" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "vehicles" ("id" SERIAL NOT NULL, "productType" character varying NOT NULL, "brand" character varying NOT NULL, "model" character varying NOT NULL, "version" character varying NOT NULL, "year" integer NOT NULL, "vin" character varying NOT NULL, "motorNumber" character varying NOT NULL, "serialNumber" character varying NOT NULL, "horsePower" integer NOT NULL, "kilometrageStart" integer NOT NULL, "kilometrageEnd" integer NOT NULL, CONSTRAINT "PK_18d8646b59304dce4af3a9e35b6" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "paymentOrders" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "distributor" character varying NOT NULL, CONSTRAINT "PK_48db8260e45e9eb4fb8381aa763" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "guarantees_status_enum" AS ENUM('1', '2', '3', '4')`);
        await queryRunner.query(`CREATE TABLE "guarantees" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "status" "guarantees_status_enum" NOT NULL, "startDate" TIMESTAMP NOT NULL, "endDate" TIMESTAMP NOT NULL, "amount" integer, "paymentOrderId" integer, "invoiceDate" TIMESTAMP, "clientId" integer, "vehicleId" integer, CONSTRAINT "REL_c02a0e1902c818d3819c438528" UNIQUE ("clientId"), CONSTRAINT "REL_ddc9998e3c112e3f0b25891069" UNIQUE ("vehicleId"), CONSTRAINT "PK_0952d3cdbdaa3d2a5d2089ceed3" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "guarantees" ADD CONSTRAINT "FK_e9a35a5340711c2b14b63ac41a8" FOREIGN KEY ("paymentOrderId") REFERENCES "paymentOrders"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
