...
export class RemovePaymentOrderDistributor1623278754446 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "groups_products_products" ADD CONSTRAINT "FK_06dc2480e5dc96e8122a97f3c04" FOREIGN KEY ("groupsId") REFERENCES "groups"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "groups_products_products" ADD CONSTRAINT "FK_aa22bdecdf0b66ce3e051ffed63" FOREIGN KEY ("productsId") REFERENCES "products"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
  }
