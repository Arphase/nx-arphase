...
export class VehiclesModuleChanges1610929454026 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "vehicles" ADD CONSTRAINT "FK_f5243d588524b2a705fcdf9b4d5" FOREIGN KEY ("companyId") REFERENCES "companies"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "vehicles" ADD CONSTRAINT "FK_20f139b9d79f917ef735efacb00" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "guarantees" ADD CONSTRAINT "REL_ddc9998e3c112e3f0b25891069" UNIQUE ("vehicleId")`,
    );
    await queryRunner.query(`COMMENT ON COLUMN "guarantees"."vehicleId" IS NULL`);
