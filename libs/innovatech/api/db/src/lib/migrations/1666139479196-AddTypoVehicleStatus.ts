...
export class AddTypoVehicleStatus1666139479196 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."vehicles_status_enum" AS ENUM('elegible', 'needsRevision', 'hasActiveGuarantee', 'notElegible', 'soldWidhoutGuarantee', 'soldWithoutGuarantee')`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."vehicles_status_enum_old" AS ENUM('elegible', 'needsRevision', 'hasActiveGuarantee', 'notElegible', 'soldWidhoutGuarantee')`,
    );
    await queryRunner.query(`ALTER TABLE "vehicles" ALTER COLUMN "status" DROP DEFAULT`);
    await queryRunner.query(
