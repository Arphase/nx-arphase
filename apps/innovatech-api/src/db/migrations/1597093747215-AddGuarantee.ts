...
export class AddGuarantee1597093747215 implements MigrationInterface {
    name = 'AddGuarantee1597093747215'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "moralPersons" ("id" SERIAL NOT NULL, "businessName" character varying NOT NULL, "constitutionDate" TIMESTAMP NOT NULL, "distributor" character varying NOT NULL, "adviser" character varying NOT NULL, "clientId" integer, CONSTRAINT "REL_e2237cc00059f04255e8da1b93" UNIQUE ("clientId"), CONSTRAINT "PK_29820f8583a7c89163c2bf90b68" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "physicalPersons" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "lastName" character varying NOT NULL, "secondLastName" character varying NOT NULL, "birthDate" TIMESTAMP NOT NULL, "clientId" integer, CONSTRAINT "REL_0427601bccfa9b30b9236fea5b" UNIQUE ("clientId"), CONSTRAINT "PK_79e51e348c67a8146d89bae0974" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "clients_persontype_enum" AS ENUM('1', '2')`);
        await queryRunner.query(`CREATE TABLE "clients" ("id" SERIAL NOT NULL, "personType" "clients_persontype_enum" NOT NULL, "rfc" character varying NOT NULL, "phone" character varying NOT NULL, "email" character varying NOT NULL, "salesPlace" character varying NOT NULL, "addressId" integer, CONSTRAINT "REL_67c4d10f39fdc8a0bbfccdcf73" UNIQUE ("addressId"), CONSTRAINT "PK_f1ab7cf3a5714dbc6bb4e1c28a4" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "guarantees" ("id" SERIAL NOT NULL, "createdAt" date NOT NULL, "status" "guarantees_status_enum" NOT NULL, "paymentOrder" character varying NOT NULL, "startDate" date NOT NULL, "endDate" date NOT NULL, "amount" integer NOT NULL, "clientId" integer, "vehicleId" integer, CONSTRAINT "REL_c02a0e1902c818d3819c438528" UNIQUE ("clientId"), CONSTRAINT "REL_ddc9998e3c112e3f0b25891069" UNIQUE ("vehicleId"), CONSTRAINT "PK_0952d3cdbdaa3d2a5d2089ceed3" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "moralPersons" ADD CONSTRAINT "FK_e2237cc00059f04255e8da1b930" FOREIGN KEY ("clientId") REFERENCES "clients"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "physicalPersons" ADD CONSTRAINT "FK_0427601bccfa9b30b9236fea5b0" FOREIGN KEY ("clientId") REFERENCES "clients"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "guarantees" ADD CONSTRAINT "FK_c02a0e1902c818d3819c4385282" FOREIGN KEY ("clientId") REFERENCES "clients"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "guarantees" ADD CONSTRAINT "FK_ddc9998e3c112e3f0b258910697" FOREIGN KEY ("vehicleId") REFERENCES "vehicles"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
