...
export class SocialEventDateAndTime1633654023776 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."socialEvents_eventplace_enum" AS ENUM('1', '2', '3', '4', '5', '6', '7')`);
        await queryRunner.query(`ALTER TABLE "socialEvents" ADD "eventPlace" "public"."socialEvents_eventplace_enum" NOT NULL`);
