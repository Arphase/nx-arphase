...
export class SoftDeleteEntities1645929605968 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "orderProductAdditionalOptions" ADD "createdAt" TIMESTAMP NOT NULL DEFAULT now()`,
    );
    await queryRunner.query(
      `ALTER TABLE "orderProductAdditionalOptions" ADD "updatedAt" TIMESTAMP NOT NULL DEFAULT now()`,
    );
