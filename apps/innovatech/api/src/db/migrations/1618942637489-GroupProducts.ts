...
export class GroupProducts1618942637489 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "groups_products_products" ("groupsId" integer NOT NULL, "productsId" integer NOT NULL, CONSTRAINT "PK_7c384308d9f8c66801e1b77f675" PRIMARY KEY ("groupsId", "productsId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_06dc2480e5dc96e8122a97f3c0" ON "groups_products_products" ("groupsId") `);
        await queryRunner.query(`CREATE INDEX "IDX_aa22bdecdf0b66ce3e051ffed6" ON "groups_products_products" ("productsId") `);
