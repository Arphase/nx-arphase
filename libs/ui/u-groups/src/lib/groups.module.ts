...
import { GroupFormParentComponent } from './components/group-form-parent/group-form-parent.component';
...
@NgModule({
  ...
  declarations: [GroupsComponent, GroupCompanyListComponent, GroupListComponent, GroupListContainerComponent, GroupFormsContainerComponent, GroupsTabContainerComponent, GroupFormsComponent, GroupFormParentComponent, GroupFormCompaniesComponent, GroupFormUsersComponent],
})
