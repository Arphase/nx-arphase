...
export class CascadeDeleteVehicleForeignKeys1620152890674 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "revisionRequests" ADD CONSTRAINT "FK_edca98d20aaea702aec48832957" FOREIGN KEY ("vehicleId") REFERENCES "vehicles"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "revisions" ADD CONSTRAINT "FK_4b822f5ec8e8f3342337518df23" FOREIGN KEY ("vehicleId") REFERENCES "vehicles"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
