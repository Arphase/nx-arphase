...
export class RevisionRequestModel1611878759154 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "revisionRequests" ADD CONSTRAINT "FK_2bdb06f8ed3aeb6383b327c6957" FOREIGN KEY ("addressId") REFERENCES "addresses"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "revisionRequests" ADD CONSTRAINT "FK_da9b669c0c674df2292c39a9696" FOREIGN KEY ("companyId") REFERENCES "companies"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "revisionRequests" ADD CONSTRAINT "FK_1fff66f1be1e1323467cbc36469" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "guarantees" ADD CONSTRAINT "FK_ddc9998e3c112e3f0b258910697" FOREIGN KEY ("vehicleId") REFERENCES "vehicles"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }
